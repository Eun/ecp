...
extern void *md5_finish_ctx (FILE* dststream, struct md5_ctx *ctx, void *resbuf) __THROW;
...
extern int md5_stream (FILE *stream, FILE *dststream, void *resblock) __THROW;
